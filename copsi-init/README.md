...
>***TL;TR*** Version steht im wiki seite von Service Deployment im KoP OCP4 unter dies Link [Das erste Service-Deployment](https://wiki.system.local/spaces/elpa/pages/465567233/Service+Deployment+im+KoP+OCP4#ServiceDeploymentimKoP(OCP4)-DasersteService-Deployment)
